...
define('app',["jquery", "lodash", "backbone", "plugins/backbone.layoutmanager"], function($, _, Backbone) {
  var JST, app;
  app = {
    root: "./"
  };
...
define('modules/contact',["jquery", "lodash", "backbone", "app"], function($, _, Backbone, app) {
  var Contact;
  Contact = app.module();
...
define('router',["app", "modules/contact"], function(app, Contact) {
  var Router;
