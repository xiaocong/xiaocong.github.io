...
define('models/contact',['use!underscore', 'use!backbone'], function(_, Backbone) {
  var Contact;
...
define('store',['use!underscore', 'use!backbone'], function(_, Backbone) {
  var S4, Store, guid;
  S4 = function() {
...
define('collections/contacts',['use!underscore', 'use!backbone', 'models/contact', 'store'], function(_, Backbone, Contact, Store) {
  var Contacts;
