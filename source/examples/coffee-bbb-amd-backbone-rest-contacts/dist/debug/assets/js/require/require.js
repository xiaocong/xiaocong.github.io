...
define('models/contact',['underscore', 'backbone'], function(_, Backbone) {
  var Contact;
...
define('collections/contacts',['underscore', 'backbone', 'models/contact'], function(_, Backbone, Contact) {
  var Contacts;
...
define('views/contactitem',["jquery", "underscore", "backbone", "text!templates/item.html"], function($, _, Backbone, tplItem) {
  var ContactItemView;
...
define('views/sidebar',["jquery", "underscore", "backbone", "collections/contacts", "models/contact", "views/contactitem", "text!templates/sidebar.html"], function($, _, Backbone, contacts, Contact, ContactItemView, tplSidebar) {
  var SidebarView;
...
define('views/show',["jquery", "underscore", "backbone", "text!templates/show.html"], function($, _, Backbone, tplShow) {
  var ShowView;
...
define('views/edit',["jquery", "underscore", "backbone", "text!templates/edit.html"], function($, _, Backbone, tplEdit) {
  var EditView;
...
define('views/main',["jquery", "underscore", "backbone", "views/show", "views/edit"], function($, _, Backbone, showView, editView) {
  var MainView;
...
define('views/app',["domReady!", "jquery", "underscore", "backbone", "views/sidebar", "views/main"], function(doc, $, _, Backbone, sidebarView, mainView) {
  var AppView;
...
define('router',['jquery', 'underscore', 'backbone', 'collections/contacts', 'views/app'], function($, _, Backbone, contacts, appView) {
  var AppRouter;
...
define('namespace',['underscore', 'backbone'], function(_, Backbone) {
  var global;
  global = {};
...
define('app',['jquery', 'underscore', 'backbone', 'collections/contacts', 'router', 'views/app', 'namespace'], function($, _, Backbone, contacts, appRouter, appView, global) {
  var initialize;
  initialize = function() {
    global.app = {
      contacts: contacts,
